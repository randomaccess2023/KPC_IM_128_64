...
- 'Figures' (another folder) has every figure used in the manuscript (including `Spporting information` segment). The `Supporting information` figures in the paper can be found in the `Additional information` subfolder. Besides, some high resolution WSIs can also be found here.
